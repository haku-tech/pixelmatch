...
void diffTest(String imgPath1, String imgPath2, String diffPath, Map<String, dynamic> options, int expectedMismatch) {
  ...
  test(info, () {
    ...
    final mismatch = pixelmatch(img1.toUint8List(), img2.toUint8List(), out, width, height, options);
    final mismatch2 = pixelmatch(img1.toUint8List(), img2.toUint8List(), null, width, height, options);
